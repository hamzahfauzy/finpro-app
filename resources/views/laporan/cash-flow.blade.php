                ...
                <div class="overflow-x-auto">
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($data['masuk'] as $tipe => $listKategori)
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                        <span class="font-mono font-bold">
                                            Rp {{ number_format($paket['bulan'][$i], 0, ',', '.') }}
                                        </span>
                                    </td>
                                    @endforeach
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                        <span class="font-mono font-bold">
                                            Rp {{ number_format(array_sum($paket['bulan']), 0, ',', '.') }}
                                        </span>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <tfoot>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <span class="font-mono font-bold">
                                        Rp {{ number_format($grandMasuk['bulan'][$i], 0, ',', '.') }}
                                    </span>
                                </td>
                                @endforeach
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <span class="font-mono font-bold">
                                        Rp {{ number_format($grandMasuk['total'], 0, ',', '.') }}
                                    </span>
                                </td>
                            </tr>
                        </tfoot>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg border border-gray-200">
                <div class="overflow-x-auto">
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($data['keluar'] as $tipe => $listKategori)
                                @foreach ($listKategori as $kategori)
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                        ...
                        <tfoot>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <span class="font-mono font-bold">
                                        Rp {{ number_format($grandKeluar['bulan'][$i], 0, ',', '.') }}
                                    </span>
                                </td>
                                @endforeach
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <span class="font-mono font-bold">
                                        Rp {{ number_format($grandKeluar['total'], 0, ',', '.') }}
                                    </span>
                                </td>
                            </tr>
                        </tfoot>
                    ...
                    <table class="w-full divide-y divide-gray-200">
                        ...
                        <tfoot>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <span class="font-mono font-bold">
                                        Rp {{ number_format($grandSaldo['bulan'][$i], 0, ',', '.') }}
                                    </span>
                                </td>
                                @endforeach
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                    <span class="font-mono font-bold">
                                        Rp {{ number_format($grandSaldo['total'], 0, ',', '.') }}
                                    </span>
                                </td>
                            </tr>
                        </tfoot>
